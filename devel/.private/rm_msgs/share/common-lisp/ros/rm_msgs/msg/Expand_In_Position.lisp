...
;//! \htmlinclude Expand_In_Position.msg.html

(cl:defclass <Expand_In_Position> (roslisp-msg-protocol:ros-message)
  ((device
    :reader device
    :initarg :device
    :type cl:fixnum
...
(cl:defclass Expand_In_Position (<Expand_In_Position>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Expand_In_Position>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Expand_In_Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_msgs-msg:<Expand_In_Position> is deprecated: use rm_msgs-msg:Expand_In_Position instead.")))

(cl:ensure-generic-function 'device-val :lambda-list '(m))
(cl:defmethod device-val ((m <Expand_In_Position>))
...
(cl:defmethod state-val ((m <Expand_In_Position>))
...
(cl:defmethod trajectory_connect-val ((m <Expand_In_Position>))
...
(cl:defmethod trajectory_state-val ((m <Expand_In_Position>))
  ...
  (trajectory_state m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Expand_In_Position>) ostream)
  "Serializes a message object of type '<Expand_In_Position>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Expand_In_Position>) istream)
  "Deserializes a message object of type '<Expand_In_Position>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Expand_In_Position>)))
  "Returns string type for a message object of type '<Expand_In_Position>"
  "rm_msgs/Expand_In_Position")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Expand_In_Position)))
  "Returns string type for a message object of type 'Expand_In_Position"
  "rm_msgs/Expand_In_Position")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Expand_In_Position>)))
  "Returns md5sum for a message object of type '<Expand_In_Position>"
  "8560798487e4b58bf325a3d3d0cad027")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Expand_In_Position)))
  "Returns md5sum for a message object of type 'Expand_In_Position"
  "8560798487e4b58bf325a3d3d0cad027")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Expand_In_Position>)))
  "Returns full string definition for message of type '<Expand_In_Position>"
  (cl:format cl:nil "uint8 device~%string state~%uint8 trajectory_connect~%bool trajectory_state~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Expand_In_Position)))
  "Returns full string definition for message of type 'Expand_In_Position"
  (cl:format cl:nil "uint8 device~%string state~%uint8 trajectory_connect~%bool trajectory_state~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Expand_In_Position>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Expand_In_Position>))
  "Converts a ROS message object to a list"
  (cl:list 'Expand_In_Position
