...
;//! \htmlinclude Gettrajectorylist.msg.html

(cl:defclass <Gettrajectorylist> (roslisp-msg-protocol:ros-message)
  ((page_num
    :reader page_num
    :initarg :page_num
    :type cl:integer
...
(cl:defclass Gettrajectorylist (<Gettrajectorylist>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Gettrajectorylist>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Gettrajectorylist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_msgs-msg:<Gettrajectorylist> is deprecated: use rm_msgs-msg:Gettrajectorylist instead.")))

(cl:ensure-generic-function 'page_num-val :lambda-list '(m))
(cl:defmethod page_num-val ((m <Gettrajectorylist>))
...
(cl:defmethod page_size-val ((m <Gettrajectorylist>))
...
(cl:defmethod vague_search-val ((m <Gettrajectorylist>))
  ...
  (vague_search m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Gettrajectorylist>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Gettrajectorylist>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Gettrajectorylist>)))
  "Returns string type for a message object of type '<Gettrajectorylist>"
  "rm_msgs/Gettrajectorylist")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Gettrajectorylist)))
  "Returns string type for a message object of type 'Gettrajectorylist"
  "rm_msgs/Gettrajectorylist")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Gettrajectorylist>)))
  "Returns md5sum for a message object of type '<Gettrajectorylist>"
  "cbe34dfd8b66421bedf70042e463f5a2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Gettrajectorylist)))
  "Returns md5sum for a message object of type 'Gettrajectorylist"
  "cbe34dfd8b66421bedf70042e463f5a2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Gettrajectorylist>)))
  "Returns full string definition for message of type '<Gettrajectorylist>"
  (cl:format cl:nil "int32 page_num~%int32 page_size~%string vague_search~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Gettrajectorylist)))
  "Returns full string definition for message of type 'Gettrajectorylist"
  (cl:format cl:nil "int32 page_num~%int32 page_size~%string vague_search~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Gettrajectorylist>))
  (cl:+ 0
     4
     4
     4 (cl:length (cl:slot-value msg 'vague_search))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Gettrajectorylist>))
  "Converts a ROS message object to a list"
  (cl:list 'Gettrajectorylist
