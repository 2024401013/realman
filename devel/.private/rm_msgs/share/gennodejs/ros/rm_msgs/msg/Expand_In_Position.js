...
class Expand_In_Position {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Expand_In_Position(null);
  ...
  static datatype() {
    ...
    return 'rm_msgs/Expand_In_Position';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Expand_In_Position(null);
...
module.exports = Expand_In_Position;
