...
class Get_TCP_Master_List_Param {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Get_TCP_Master_List_Param(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Get_TCP_Master_List_Param(null);
...
module.exports = Get_TCP_Master_List_Param;
